...
- **"Designer" is a protected UK title.** The Designers Registration
  Board (arb.org.uk) enforces this. Only individuals on the ARB
  register can call themselves designers. If neither director is
  currently on the register, all instances of "designer(s)" should be

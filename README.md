...
services.html       Services hub: 7 sections + councils strip + FAQ
services/…          7 service detail pages (educate-then-convert template
                    with sticky quote sidebar); generated by build_services.py
...
build_pages.py      Page generator; run first, then build_services.py

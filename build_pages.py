...
<section id="directors">
  <div class="wrap">
    <div class="sec-label"><span>Studio leads</span><em class="sec-sub">Two directors. Every project. No handovers.</em><a class="link" href="about.html">More about the practice</a></div>
    ...
    <p class="founding-note brand-copy">FADP is a new London practice. Between them, its directors have delivered projects of every scale and stage inside established firms &#8212; houses, extensions, commercial and mixed-use. That experience now goes straight into your project, director-led, with terms most practices will not put in writing. Be one of our first clients.</p>
  </div>
</section>
...
<div class="news-head">
  <div class="wrap">
    <div class="nh-row">
      <h1>Blog</h1>
      <span class="nh-count"><span id="artCount">6</span> articles</span>
    </div>
  </div>
</div>
...
<div class="news-filters">
  <div class="wrap">
    <div class="nf-row">
        ...
        <button class="filter-pill" data-filter="Regulations">Regulations</button>
...
<section class="news-list-wrap">
  <div class="wrap">
    <div class="news-list">
      <article class="news-row" data-cat="Planning">
        <a class="nr-img" href="blog/planning-permission-rear-extension.html"><img src="{IMG['p5']}" alt="" loading="lazy"></a>
        <div class="nr-body">
          <a class="nr-title" href="blog/planning-permission-rear-extension.html"><h3>Do you need planning permission for a rear extension?</h3></a>
          <div class="nr-meta">Planning &#183; 7 min read</div>
          ...
          <a class="pill-btn" href="blog/planning-permission-rear-extension.html">Read article</a>
        </div>
      </article>
      <article class="news-row" data-cat="Heritage">
        <a class="nr-img" href="blog/listed-building-consent.html"><img src="{IMG['listed']}" alt="" loading="lazy"></a>
        <div class="nr-body">
          <a class="nr-title" href="blog/listed-building-consent.html"><h3>Listed building consent, explained</h3></a>
          <div class="nr-meta">Heritage &#183; 8 min read</div>
          <p>A separate regime with its own tests and, unusually in planning law, criminal liability. How the system actually works, and how consent is won.</p>
          <a class="pill-btn" href="blog/listed-building-consent.html">Read article</a>
        </div>
      </article>
      <article class="news-row" data-cat="Regulations">
        <a class="nr-img" href="blog/principal-designer-explained.html"><img src="{IMG['studio']}" alt="" loading="lazy"></a>
        <div class="nr-body">
          <a class="nr-title" href="blog/principal-designer-explained.html"><h3>What does a Principal Designer actually do?</h3></a>
          <div class="nr-meta">Regulations &#183; 8 min read</div>
          ...
          <a class="pill-btn" href="blog/principal-designer-explained.html">Read article</a>
        </div>
      </article>
      <article class="news-row" data-cat="Heritage">
        <a class="nr-img" href="blog/conservation-area-permitted-development.html"><img src="{IMG['p8']}" alt="" loading="lazy"></a>
        <div class="nr-body">
          <a class="nr-title" href="blog/conservation-area-permitted-development.html"><h3>Permitted development in conservation areas</h3></a>
          <div class="nr-meta">Heritage &#183; 7 min read</div>
          ...
          <a class="pill-btn" href="blog/conservation-area-permitted-development.html">Read article</a>
        </div>
      </article>
      <article class="news-row" data-cat="Technical">
        <a class="nr-img" href="blog/how-bim-cuts-construction-costs.html"><img src="{IMG['model']}" alt="" loading="lazy"></a>
        <div class="nr-body">
          <a class="nr-title" href="blog/how-bim-cuts-construction-costs.html"><h3>How BIM cuts construction costs: the evidence</h3></a>
          <div class="nr-meta">Technical &#183; 7 min read</div>
          ...
          <a class="pill-btn" href="blog/how-bim-cuts-construction-costs.html">Read article</a>
        </div>
      </article>
      <article class="news-row" data-cat="Before you buy">
        <a class="nr-img" href="blog/feasibility-studies-before-you-buy.html"><img src="{IMG['p7']}" alt="" loading="lazy"></a>
        <div class="nr-body">
          <a class="nr-title" href="blog/feasibility-studies-before-you-buy.html"><h3>Feasibility studies: what you learn before you spend</h3></a>
          <div class="nr-meta">Before you buy &#183; 6 min read</div>
          <p>What can be built, will it get planning, and what will it cost. The cheapest decision on the whole project, made first.</p>
          <a class="pill-btn" href="blog/feasibility-studies-before-you-buy.html">Read article</a>
        </div>
      </article>
    </div>

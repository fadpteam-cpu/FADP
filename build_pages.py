...
def trust_band():
  ...
  <div class="wrap">
    <ul>
      ...
      <li>ARB Registered Architects</li>
    ...
    <div class="case">
      ...
      <div class="case-body">
        ...
        <div class="case-facts">
          ...
          Role: full service, RIBA-equivalent stages 0 to 6
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="wrap">
    <div class="narrative">
      <div class="n-copy">
        ...
        <div class="creds-row">
          <div class="cred-item"><h4>RIBA</h4><p>Chartered Practice</p></div>
          <div class="cred-item"><h4>ARB</h4><p>Registered architects</p></div>
          <div class="cred-item"><h4>PII</h4><p>Full professional indemnity insurance</p></div>
          <div class="cred-item"><h4>Est. 2014</h4><p>140+ completed projects</p></div>
        </div>
      </div>
      <div class="n-img">
